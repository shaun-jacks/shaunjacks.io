...
![Cost function with rate of change](cost-fxn-tangent.png)
...
- $ \frac{\partial}{\partial\theta_{j}}J(\theta)$ is the partial derivative of $J(\theta)$ with respect to $\theta_{j}$
  ...
  - this is how we get the slope of this line:
    ![Cost function with tangent line](cost-fxn-tangent.png)
...
![Cost function with tangent line after converging](cost-fxn-tangent-end.png)
...
![Gradient Descent Linear Regression](output_1_1.png)
...
![Gradient Descent Linear Regression](output_14_1.png)
...
![Plot of data](gradient-linear_files/figure-markdown_strict/unnamed-chunk-4-1.png)
...
![Plotted Line on data](gradient-linear_files/figure-markdown_strict/unnamed-chunk-7-1.png)
