...
I want to record all that I had done, starting from zero programming experience, and explain how I progressed to the software engineer I am today.

I'd like to give some hope and insight to others through my journey.

I start with where I am now as of October 2020, and go back to where I started, and progress with information about the most important events and habits that got me to where I am today.

# Where I am

## 2020

Currently, I am a junior software engineer at Sony Playstation. I work on the Cloud Frontend team.

I primarily use Angular, a modern frontend framework, and have been loving practicing reactive programming with RxJS. While I specialize in Angular in this role, there are plenty of opportunities to learn other technologies that excite me.
...
Graduating from school, I had zero internship experience. All I had was a degree, and a passion to learn more and grow. I wasn't sure what I wanted to do just yet, but I knew I wanted to write code to provide a positive impact.

I found my first job in research and data science at the U.C. Davis MIND Institute working as a Junior Specialist.
...
I had a hard time knowing where to start. To start building projects out of knowing nothing, one of my first learning resources was through YouTube. I discovered I needed to learn about frontend and backend to build full-stack projects.

I started by coding along with [Brad Traversy's youtube videos](https://www.youtube.com/user/TechGuyWeb). It was so fun seeing the code I wrote spring to life on a computer!

I then found an **amazing** set of courses on [codewithmosh.com](https://codewithmosh.com/) (also found through YouTube). I went through his [Mastering React](https://codewithmosh.com/p/mastering-react) to learn modern frontend, and [Node.js](https://codewithmosh.com/p/the-complete-node-js-course) to learn backend courses.

I also found a great set of [Udemy courses by Maximilian Schwarzmüller](https://www.udemy.com/user/maximilian-schwarzmuller/) on web development projects. I followed his courses to further learn about full stack javascript.

Last but not least, I went through one of my favorite Udemy courses on understanding how Javascript works as a language. This course was beautifully made, and was called [Javascript: Understanding the weird parts](https://www.udemy.com/course/understand-javascript/).

## My projects

I used all the resources I found online, to start building personal projects. First, I learned HTML and CSS and Gatsby all at the same time. How? By building [my first version of my personal website](https://shaunjacks.com/)! This project was so addicting, I was able to pick up CSS within a few weeks, and [Gatsby](https://www.gatsbyjs.com/) in a few weeks.

One of the biggest projects I worked on was a music social media application called [Musenture](https://musenture-fcc94.firebaseapp.com/). It was a full stack application where I had [frontend](https://github.com/shaun-jacks/musenture-frontend) and [backend](https://github.com/shaun-jacks/musenture-backend) code, that taught my how to build a full stack application.

One weekend I felt very inspired, and created a frontend prototype of a [Music Admin application](https://react-data-dashboard.firebaseapp.com/) using React.js.

I also have a passion to learn more about data science in general, and followed tutorials by [fast.ai](https://www.fast.ai/) to create a deep learning computer vision classifier to identify cells with Malaria documented in [this notebook](https://github.com/shaun-jacks/malaria_identify_kaggle/blob/master/lesson1-application-malaria-detection.ipynb).
...
These projects also contributed to my resume, and were talking points within interviews. I also demoed my projects during my onsite interviews. This was nerve-wrecking, but I think it helped me stand out in retrospect.
...
### 2 Page Resume? No problem!

The one page resume rule is old and limiting in my opinion. I personally think it's okay to have a two page resume, and have used a two page resume in my applications.

Here is an example of [one of my resumes](https://drive.google.com/file/d/13Y-pgsTGqy3SkKf2uNI1xhnH-vAu-DD-/view?usp=sharing).
...
1. Practice problems in [Cracking The Coding Interview](http://www.crackingthecodinginterview.com/), go through the first set of problems in a variety of sections
2. Practice problems in [Elements of Programming Interviews](https://elementsofprogramminginterviews.com/) in your language of choice (the problems in here are also amazing and solutions described well), also start with the first problems and focus on variety of problems
3. Practice sets of problems on [Leetcode](https://leetcode.com/).
...
I did this consistently for a few months, and aimed for at least 1-3 problems a day. When I was nearing my interviews, I upped the number of problems per day dramatically.

## Behavioral Interview Prep

To prepare for the behavioral interview, I went back to the key, **think about your S.T.A.R. stories!**. I created at least 3 pages of S.T.A.R. stories to reference.

Next, I wrote down at least 20 behavioral interview questions that were general.
**I then connected my S.T.A.R. stories to each behavioral question.** I found an amazing resource called the [tech interview handbook](https://yangshun.github.io/tech-interview-handbook/) that had [a great set of behavioral questions](https://yangshun.github.io/tech-interview-handbook/behavioral-questions) to start with.

I would practice speaking out loud answers to each one. I also practiced with friends and family, having them ask me questions, and me answering them.
...
I made sure [my LinkedIn](https://www.linkedin.com/in/shaun-jackson/) was as up to date as possible! The primary source I found and applied for roles was through LinkedIn. This is perhaps one of the most important steps in preparation, make sure you have a LinkedIn and Github!
...
- Learn by **consistently doing** through building **hands-on projects** that could be showcased
  ...
  - Demo it during interviews if possible
...
- Become active on LinkedIn and Github to showcase skills and find positions
